    ...
    return (
      <div className="mt-24 ml-8">
        <div className="flex justify-between items-center">
          <div className="text-2xl rounded-md font-bold bg-sky-300 text-white px-3 py-1">
            Welcome to our DevTalk Platform
          </div>
          <div>
            {badge === "gold" ? (
              <>
        ...
        <div className="flex mt-6 flex-col justify-center max-w-96 mx-auto p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
          <img
            src={dbUser?.image}
            alt=""
          ...
          <div className="space-y-4 text-center divide-y dark:divide-gray-300">
            <div className="my-2 space-y-1">
              ...
              <p className="px-5 text-xs sm:text-base dark:text-gray-600">
                <p className="bg-secondary text-white rounded-lg p-2 font-medium">
                  Badge: {dbUser?.badge}
                </p>
              </p>
            </div>
